...
public record ParameterInvocationHint(
  ...
  @NonNull Function<HttpContext, Object> valueResolver
) {
   ...
   */
  public @Nullable Object resolveValue(@NonNull HttpContext context) {
    return this.valueResolver.apply(context);
  }
}
